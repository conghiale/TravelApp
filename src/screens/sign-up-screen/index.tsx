    ...
    <SafeAreaWrapper>
      ...
      <Box
        ...
        <View style={{marginHorizontal: 30, gap: 20}}>
          ...
          <View>
            <TextInput
              onChangeText={text => handleInputText('firstName', text)}
              placeholder="First name"
              style={styles.textInput}
            />
            {userError.firstName.show ? (
              <Text style={{...styles.invalid}}>
                {userError.firstName.message}
              </Text>
            ) : (
              ''
            )}
          ...
          <View>
            <TextInput
              onChangeText={text => handleInputText('lastName', text)}
              placeholder="Last name"
              style={styles.textInput}
            />
            {userError.lastName.show ? (
              <Text style={{...styles.invalid}}>
                {userError.lastName.message}
              </Text>
            ) : (
              ''
            )}
          ...
          <View>
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <TextInput
                onChangeText={text => handleInputText('cfPassword', text)}
              ...
              <TouchableOpacity
                ...
                style={{position: 'absolute', right: 16}}>
                <Icons
                  name={showConfirmPassword ? 'eye' : 'uneye'}
                  color="#000"
                />
              </TouchableOpacity>
            </View>
            {userError.cfPassword.show ? (
              <Text style={{...styles.invalid}}>
                {userError.cfPassword.message}
              </Text>
            ) : (
              ''
            )}
          ...
          <TouchableOpacity
            ...
            <Text style={styles.buttonText}>
              Sign up <Icons name="in" color="#fff" />
            </Text>
          </TouchableOpacity>
