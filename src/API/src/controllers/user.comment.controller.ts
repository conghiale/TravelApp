...
class UserCommentController {
  ...
  updateComment = async (req: Request, res: Response) => {
    try {
      ...
      const result = await this.userCommentService.updateComment(id, content, star);
  ...
  getCommentsByDestinationId = async (req: Request, res: Response) => {
    try {
      ...
      const result = await this.userCommentService.getCommentsByDestinationId(destinationId);
